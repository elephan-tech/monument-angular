export const slideOpts = {
  ...
  coverflow: {
    ...
    coverflowEffect: {
      slideShadows: false,
      rotate: 0,
      stretch: 500, // stretch the spacing and density between the left and right pictures
      Depth: 0, // Depth Switch the spacing and density between the top and bottom of pictures
      modifier: 0.8,
    },
    on: {
      beforeInit(): void {
